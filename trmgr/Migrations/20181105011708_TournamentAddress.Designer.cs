...
namespace trmgr.Migrations
{
    ...
    [Migration("20181105011708_TournamentAddress")]
    partial class TournamentAddress
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("trmgr.Models.DatabaseModels.Organization.DivisionGroup", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
            ...
            modelBuilder.Entity("trmgr.Models.DatabaseModels.Organization.AgeCategory", b =>
                {
                    ...
                    b.HasOne("trmgr.Models.DatabaseModels.Organization.DivisionGroup")
                        .WithMany("AgeCategories")
            ...
            modelBuilder.Entity("trmgr.Models.DatabaseModels.Organization.DivisionGroup", b =>
                {
                    b.HasOne("trmgr.Models.DatabaseModels.Organization.GenderCategory", "GenderCategory")
                        .WithMany()
